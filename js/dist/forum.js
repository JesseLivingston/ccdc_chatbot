...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('ccdc/chatbot', function () {
  ...
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_components_PostUser__WEBPACK_IMPORTED_MODULE_2___default().prototype), 'view', function (view) {
    ...
    if (!user || flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().forum.attribute('chatBotUserPromptId') !== user.id()) return;
    // console.log('-----------------' + app.forum.attribute('chatBotBadgeText'));
    view.children.push(m("div", {
      className: "UserPromo-badge"
    }, m("div", {
      className: "badge"
    }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().forum.attribute('chatBotBadgeText'))));
  });
});
